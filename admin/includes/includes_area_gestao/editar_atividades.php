<?php
    ...
    if (isset($_POST["edit_button_confirm"])) {
        ...
        $stmt->execute([":novoNomeAtividade" => $novoNomeatividade, ":novaDescricaoAtividade" => $novaDescricaoAtividade, ":novaZonaAtividade" => $novaZonaAtividade, ":novaDuracaoAtividade" => $novaDuracaoAtividade, ":novoPrecoAtividade" => $novoCustoAtividade, ":idAtividade" => $idAtividade]);
        ...
        ?>
            ...
            <div class="list-group" id="<?php echo $activity->idAtividade; ?>">
                ...
                <form action="" method="post">
                    ...
                    <br>
                    <input class="new_image" type="file" name="novo_ficheiro_imagem" value="<?php echo $activity->imagemAtividade; ?>">
                    <br>
